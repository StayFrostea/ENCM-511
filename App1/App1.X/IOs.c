...
//            LATBbits.LATB8 = 1; // LED on
//            break;
//        case 4: //No buttons, time = 0, running, alarm
//            NewClk(8);
//            Disp2String("\r"); // print time to terminal
//            Disp2Dec(time / 60 * 1000);
//            Disp2String("m : ");
...
//            NewClk(32); // slow down clock for delay and other tasks
//            break;
//        case 5: //No buttons, time !=0, running
//            if (time > 0 && runFlag == 1) {
//                delay_ms(1000, 1); // 1 sec delay
//                time -= 1; // decrease timer
//            }
...
//        c = 2;
//    } else if ((PORTAbits.RA2 == 1 && PORTAbits.RA4 == 1 && PORTBbits.RB4 == 1) && (runFlag==0)) {
//        c = 3;
